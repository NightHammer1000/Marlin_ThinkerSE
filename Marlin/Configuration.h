...
#define STRING_CONFIG_H_AUTHOR "(NightStorm1000, THINKER SE default config)" // Who made the changes.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_THINKER_RAMBO
#endif

// Name displayed in the LCD "Ready" message and Info menu
#define CUSTOM_MACHINE_NAME "Thinker SE 2.0.x_Bugfix"
